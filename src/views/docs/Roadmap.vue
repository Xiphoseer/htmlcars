<template>
  <div id="roadmap">
    ...
    <ul>
      ...
      <li>Implement an algorithm that places widgets based on input and usage data</li>
      <li>Adapt this into a proper ES Module / Vue library</li>
    </ul>
    <h2>Components</h2>
    <p>
